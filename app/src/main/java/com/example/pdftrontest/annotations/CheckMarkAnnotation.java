...
@Keep
public class CheckMarkAnnotation extends Stamper {
    ...
    public CheckMarkAnnotation(@NonNull PDFViewCtrl ctrl) {
        super(ctrl);
    }
    ...
    protected void addStamp() {
        File resource = Utils.copyResourceToLocal(mPdfViewCtrl.getContext(), R.raw.ic_checkmark, "CheckMark", "png");
    ...
    private boolean addImageStamp(Uri uri, int imageRotation, String filePath) {
        ...
        try {
            ...
            com.pdftron.pdf.Stamper stamper = new com.pdftron.pdf.Stamper(2, 70, 70);
            if (this.mTargetPoint != null) {
